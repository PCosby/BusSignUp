document.getElementById("signup").onclick = function(){
    forward();
    activate(document.getElementById("navsign"),"pics/boardY.png");
}
document.getElementById("routes").onclick = function(){
    forward()
    activate(document.getElementById("navroute"),"pics/mapY.png");
}
document.getElementById("navroute").onclick = function(){
    if(activated!="navroute"){
    deactivate(document.getElementById("navsign"),"pics/board.png");
    activate(document.getElementById("navroute"),"pics/mapY.png");
    }
}
document.getElementById("navsign").onclick = function(){
    if(activated!="navsign"){
    deactivate(document.getElementById("navroute"),"pics/map.png");
    activate(document.getElementById("navsign"),"pics/boardY.png");
    }
}
